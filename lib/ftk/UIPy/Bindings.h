...
namespace ftk
{
    namespace python
    {
        ...
        FTK_API void actionGroup(pybind11::module_&);
        ...
        FTK_API void drivesModel(pybind11::module_&);
        ...
        FTK_API void floatEditShuttle(pybind11::module_&);
        ...
        FTK_API void levelsSlider(pybind11::module_&);
        FTK_API void lineEdit(pybind11::module_&);
        FTK_API void lineEditModel(pybind11::module_&);
        FTK_API void listItemsWidget(pybind11::module_&);
        FTK_API void listWidget(pybind11::module_&);
        ...
        FTK_API void overlayLayout(pybind11::module_&);
        FTK_API void pieChart(pybind11::module_&);
        ...
        FTK_API void screenshotTag(pybind11::module_&);
        FTK_API void scrollArea(pybind11::module_&);
        FTK_API void scrollBar(pybind11::module_&);
        FTK_API void scrollWidget(pybind11::module_&);
        FTK_API void searchBox(pybind11::module_&);
        FTK_API void settings(pybind11::module_&);
        FTK_API void shuttleWidget(pybind11::module_&);
        FTK_API void spacer(pybind11::module_&);
        FTK_API void splitter(pybind11::module_&);
        FTK_API void splitter2D(pybind11::module_&);
        FTK_API void stackLayout(pybind11::module_&);
        FTK_API void style(pybind11::module_&);
        FTK_API void svgWidget(pybind11::module_&);
        FTK_API void sysLogModel(pybind11::module_&);
        FTK_API void tabBar(pybind11::module_&);
        FTK_API void tabWidget(pybind11::module_&);
        FTK_API void textEdit(pybind11::module_&);
        FTK_API void textEditModel(pybind11::module_&);
        FTK_API void toolBar(pybind11::module_&);
        FTK_API void toolButton(pybind11::module_&);
        FTK_API void tooltip(pybind11::module_&);
