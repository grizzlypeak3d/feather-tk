    ...
    namespace python
    {
        void scrollWidget(py::module_& m)
        {
            ...
            py::class_<ScrollWidget, IWidget, std::shared_ptr<ScrollWidget> >(m, "ScrollWidget")
                ...
                .def_property_readonly("scrollSize", &ScrollWidget::getScrollSize, py::return_value_policy::copy)
                ...
                .def_property_readonly("scrollPos", &ScrollWidget::getScrollPos, py::return_value_policy::copy)
