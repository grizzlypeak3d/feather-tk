    ...
    namespace gl
    {
        ...
        namespace
        {
            ...
            const std::string sampleTexture =
                ...
                "        {\n"
                "            float y  = clamp((texture2D(s0, textureCoord).r - (16.0 / 255.0)) * (255.0 / (235.0 - 16.0)), 0.0, 1.0);\n"
                "            float cb = clamp((texture2D(s1, textureCoord).r - (16.0 / 255.0)) * (255.0 / (235.0 - 16.0)), 0.0, 1.0) - 0.5;\n"
                "            float cr = clamp((texture2D(s2, textureCoord).r - (16.0 / 255.0)) * (255.0 / (235.0 - 16.0)), 0.0, 1.0) - 0.5;\n"
                "            c.r = y + (yuvCoefficients.x * cr);\n"
                "            c.g = y - (yuvCoefficients.y * cr) - (yuvCoefficients.z * cb);\n"
                "            c.b = y + (yuvCoefficients.w * cb);\n"
                "        }\n"
                ...
                "        {\n"
                "            c.r = clamp((c.r - (16.0 / 255.0)) * (255.0 / (235.0 - 16.0)), 0.0, 1.0);\n"
                "            c.g = clamp((c.g - (16.0 / 255.0)) * (255.0 / (235.0 - 16.0)), 0.0, 1.0);\n"
                "            c.b = clamp((c.b - (16.0 / 255.0)) * (255.0 / (235.0 - 16.0)), 0.0, 1.0);\n"
                "        }\n"
                "\n"
