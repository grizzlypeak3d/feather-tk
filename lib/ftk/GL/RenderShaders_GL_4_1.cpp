    ...
    namespace gl
    {
        ...
        namespace
        {
            ...
            const std::string sampleTexture =
                ...
                "        {\n"
                "            float y  = clamp((texture(s0, textureCoord).r - (16.0 / 255.0)) * (255.0 / (235.0 - 16.0)), 0.0, 1.0);\n"
                "            float cb = clamp((texture(s1, textureCoord).r - (16.0 / 255.0)) * (255.0 / (235.0 - 16.0)), 0.0, 1.0) - 0.5;\n"
                "            float cr = clamp((texture(s2, textureCoord).r - (16.0 / 255.0)) * (255.0 / (235.0 - 16.0)), 0.0, 1.0) - 0.5;\n"
                "            c.r = y + (yuvCoefficients.x * cr);\n"
                "            c.g = y - (yuvCoefficients.y * cr) - (yuvCoefficients.z * cb);\n"
                "            c.b = y + (yuvCoefficients.w * cb);\n"
                "        }\n"
