...
namespace ftk
{
    ...
    FTK_CORE_API Vector<2, float> round(const Vector<2, float>&);

    //! Round vector components.
    FTK_CORE_API Vector<2, float> floor(const Vector<2, float>&);

    //! Round vector components.
    FTK_CORE_API Vector<2, float> ceil(const Vector<2, float>&);

    FTK_CORE_API std::string to_string(const V2I&);
    FTK_CORE_API std::string to_string(const V2F&);
    FTK_CORE_API std::string to_string(const V3F&);
    FTK_CORE_API std::string to_string(const V4F&);

    FTK_CORE_API bool from_string(const std::string&, V2I&);
    FTK_CORE_API bool from_string(const std::string&, V2F&);
    FTK_CORE_API bool from_string(const std::string&, V3F&);
    FTK_CORE_API bool from_string(const std::string&, V4F&);

    FTK_CORE_API void to_json(nlohmann::json&, const V2I&);
    FTK_CORE_API void to_json(nlohmann::json&, const V2F&);
    FTK_CORE_API void to_json(nlohmann::json&, const V3F&);
    FTK_CORE_API void to_json(nlohmann::json&, const V4F&);

    FTK_CORE_API void from_json(const nlohmann::json&, V2I&);
    FTK_CORE_API void from_json(const nlohmann::json&, V2F&);
    FTK_CORE_API void from_json(const nlohmann::json&, V3F&);
    FTK_CORE_API void from_json(const nlohmann::json&, V4F&);
