...
namespace widgets
{
    void Buttons::_init(const std::shared_ptr<Context>& context)
    {
        ftk::IWidget::_init(context, "Buttons", nullptr);
    ...
    std::shared_ptr<Buttons> Buttons::create(const std::shared_ptr<Context>& context)
    {
