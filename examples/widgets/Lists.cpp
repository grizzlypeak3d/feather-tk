...
namespace widgets
{
    void Lists::_init(const std::shared_ptr<Context>& context)
    {
        ftk::IWidget::_init(context, "Lists", nullptr);
    ...
    std::shared_ptr<Lists> Lists::create(const std::shared_ptr<Context>& context)
    {
